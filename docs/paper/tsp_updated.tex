...
\bibitem{sa} S. Kirkpatrick, C. D. Gelatt, and M. P. Vecchi, Science {\bf 220}, 571 (1983).

\bibitem{ga} D. E. Goldberg and J. H. Holland, Machine learning {\bf 3}, 95 (1988).

\bibitem{aco} M. Dorigo, V. Maniezzo, and A. Colorni, IEEE Transactions on Systems, man, and cybernetics, Part B: Cybernetics {\bf 26}, 29 (1996).

\bibitem{feynman} R. P. Feynman, International journal of theoretical physics \textbf{21}, 467 (1982).

\bibitem{firstexp} I. L. Chuang, N. Gershenfeld, and M. Kubinec, Phys. Rev. Lett. \textbf{80}, 3408 (1998).

\bibitem{maxcut} E. Farhi, J. Goldstone, and S. Gutmann, arXiv: 1411.4028 (2014).

\bibitem{max2sat} D. Wecker, M. B. Hastings, M. Troyer, Phys. Rev. A \textbf{92}, 042303 (2015).
